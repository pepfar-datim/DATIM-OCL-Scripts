...
# resource_types = ([datim.datimbase.DatimBase.RESOURCE_TYPE_COLLECTION] +
#                   datim.datimbase.DatimBase.DEFAULT_SYNC_RESOURCE_TYPES)
# datim_sync.run(sync_mode=sync_mode, resource_types=resource_types)
