...
import settings
from datim import datimsync, datimsyncmer
...
sync_mode = datimsync.DatimSync.SYNC_MODE_BUILD_IMPORT_SCRIPT  # Set which operation is performed by this script
...
datim_sync = datimsyncmer.DatimSyncMer(
